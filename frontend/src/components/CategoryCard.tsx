...
export const CategoryCard: React.FC<CategoryCardProps> = ({
  ...
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.98 }}
      onClick={onClick}
      className={`flex flex-col items-center justify-center p-5 rounded-3xl w-28 md:w-36 h-28 md:h-36 transition-all duration-300 ${
        isActive
    ...
    >
      <div className={`p-3 rounded-2xl mb-3 transition-colors duration-300 ${
        isActive ? 'bg-white/20 text-white' : 'bg-orange-50 text-brand-orange-500'
      }`}>
