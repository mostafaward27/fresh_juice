...
export const Register: React.FC = () => {
  ...
  return (
    <div className="flex-grow flex items-center justify-center py-16 px-4 bg-gradient-to-tr from-orange-50 via-white to-slate-50 relative">
      ...
      <div className="absolute top-[20%] right-[15%] text-3xl animate-float-slow select-none pointer-events-none">🧊</div>
      <div className="absolute bottom-[20%] left-[15%] text-2xl animate-float-medium select-none pointer-events-none">🧊</div>
      ...
      <div className="w-full max-w-md bg-white/70 backdrop-blur-md border border-slate-100 p-8 rounded-[36px] shadow-2xl relative z-10 text-right">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-black text-slate-800">حساب جديد</h2>
          <p className="text-slate-500 text-xs mt-1">ابدأ تجربتك المنعشة وسجل بياناتك الآن</p>
        </div>
        ...
        <div className="text-center mt-6 border-t border-slate-100 pt-6">
          ...
          <Link to="/login" className="text-xs font-black text-brand-orange-500 hover:underline">
            سجل دخولك الآن
          </Link>
        </div>
